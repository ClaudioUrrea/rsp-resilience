...
with what the data says?  It recomputes the seven rows of Table 5, the captions
of Figures 4 and 5, the fragility numbers of Section 8.5, the sensitivity
analysis of Section 8.6 and the campaign counts, and compares each against the
...
# (A, B, delta-median, Cliff's delta, kappa*) exactly as printed in Table 5
...
def main():
    ...
    print('\nTable 5: pairwise comparison on ' + PLANT)
    ...
    print('\nSection 8.4: the sign disagreement between median and delta')
    ...
    print('\nFigure 5 caption: the weight simplex')
    ...
    print('\nFigure 4 caption: convergence for AMPC on ' + PLANT)
    r = S[(PLANT, 'AMPC')]['R0']
    ...
    print('\nSection 8.5: the sliding-mode fragility under variable latency')
    ...
    print('\nSection 8.6: the aggregation rule')
